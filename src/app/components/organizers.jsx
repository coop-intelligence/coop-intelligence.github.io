...
const Organizers = () => {
    return <div className="text-justify">
        <div className="grid sm:grid-cols-4 grid-cols-2 mt-4 gap-y-6">
            ...
            <PersonAvatar name="Walter Zimmer" image="/walter_zimmer.jpeg" affiliation={"UCLA"} link={"https://walzimmer.github.io/website/"} />
            <PersonAvatar name="Ross Greer" image="/ross.png" affiliation={"UC Merced"} link={"https://www.rossgreer.com/"} />
