  ...
  return (
    <SectionCard id="sos-speakers" title="Invited Speakers" variant="spacious">
      <div>
        ...
        {/* <p className="text-pretty mt-6 text-sm text-slate-700">
          <span className="font-bold">Note: </span>We are currently extending
          invitations to other eminent research scholars, so please stay tuned
          for updates.
        </p> */}
      </div>
    </SectionCard>
