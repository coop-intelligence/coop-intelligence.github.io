  ...
  return (
    <SectionCard id="sos-organizers" title="Organizers" variant="compact">
      <div className="grid grid-cols-10 mt-1 gap-y-1 gap-x-0.5">
        ...
        <PersonAvatar name="Walter Zimmer" nameClass="text-[8px]" affilClass="text-[7px]" imageClass="w-[3em] h-[3em]" image="/walter_zimmer.jpeg" affiliation="UCLA" link="https://walzimmer.github.io/website/" />
        <PersonAvatar name="Ross Greer" nameClass="text-[8px]" affilClass="text-[7px]" imageClass="w-[3em] h-[3em]" image="/ross.png" affiliation="UC Merced" link="https://www.rossgreer.com/" />
